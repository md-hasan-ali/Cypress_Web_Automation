...
Cypress.Commands.add('typeDataSingUp', (email, password) => {
    utils.getByCssSelector(uiRegister.NAME).type(email);
    utils.getByCssSelector(uiRegister.EMAIL).type(password);
